        ...
        <div key={id} className='flex items-center py-2 justify-between'>
            ...
            <div className='flex items-center justify-end flex-col gap-1  '>
                ...
                <div className='flex items-center gap-1 justify-center'>
                    <AiOutlinePlus className='cursor-pointer border-2 rounded-md border-wood hover:bg-green hover:bg-gray-300 hover:border-none p-1 text-xl transition-all ease-linear  ' />
                    <span>{quantity}</span>
                    <AiOutlineMinus className='cursor-pointer border-2 rounded-md border-wood hover:bg-green hover:bg-gray-300 hover:border-none p-1 text-xl transition-all ease-linear  ' />
                </div>
            </div>
        </div>
    );
